...
use FregoMobileBuilder\BazBar\Sample;
...
class Test_Plugin extends \WP_UnitTestCase {
	...
	public function test_init() {
		...
		add_filter( 'frego_mobile_builder_plugin_config', [ $this, 'filter_config' ], 10, 2 );
		$plugin->init();
	...
	public function test_enqueue_block_editor_assets() {
		...
		$this->assertTrue( wp_script_is( 'frego-mobile-builder-block-editor-js', 'enqueued' ) );
		$this->assertTrue( wp_style_is( 'frego-mobile-builder-block-editor-css', 'enqueued' ) );
	}
	...
	public function test_enqueue_front_end_assets() {
		...
		$this->assertTrue( wp_script_is( 'frego-mobile-builder-front-end-js', 'enqueued' ) );
		$this->assertTrue( wp_style_is( 'frego-mobile-builder-front-end-css', 'enqueued' ) );
	}

	/**
	 * Filter to test 'frego_mobile_builder_plugin_config'.
	 *
	 * @see Plugin::init()
