<?php
/**
 * Bootstraps the Frego Mobile Builder plugin.
 *
...
class Plugin extends Plugin_Base {
	...
	public function init() {
		$this->config = apply_filters( 'frego_mobile_builder_plugin_config', $this->config, $this );
	...
	public function enqueue_block_editor_assets() {
		wp_enqueue_script(
			'frego-mobile-builder-block-editor-js',
		...
		wp_enqueue_style(
			'frego-mobile-builder-block-editor-css',
	...
	public function enqueue_front_end_assets() {
		wp_enqueue_script(
			'frego-mobile-builder-front-end-js',
		...
		wp_enqueue_style(
			'frego-mobile-builder-front-end-css',
