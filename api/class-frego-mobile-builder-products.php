...
class Mobile_Builder_Products
{
    ...
    public function get_filtered_term_product_counts($request)
    {
        ...
        $term_ids = wp_list_pluck(get_terms($request['taxonomy'], ['hide_empty' => '1']), 'term_id');
